...
We restate the full theorem with the value of the constants. Under assumption \todo{CITE}, using $n_U$ weakly labeled samples and a misspecified model yields excess generalization error
\begin{align}
