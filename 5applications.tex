...
\steve{can we replace $n$ with $n_U$ in the equation above and this section? I think that would be clearer} \bcw{+1}
%\begin{align}
$V(n) = {n}/\alpha(n)$
%\end{align}
...
% \begin{figure}
%     \centering
%     \includegraphics[width=.4\textwidth]{figures/data_value_ratio_vs_n.png}
%     %
...
% \begin{figure}
%     \centering
%     \includegraphics[width=.48\textwidth]{figures/combined.png}
%     %
